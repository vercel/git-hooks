...
if (!fs.existsSync(gitDir) || !fs.statSync(gitDir).isDirectory()) {
	console.error('△  @zeit/git-hooks: .git directory not found or is not a directory; ignoring Git hook installation:', gitDir);
	process.exit(0);
}

const hook = `#!/usr/bin/env bash
# !! AUTO-GENERATED FILE !!
# Do not edit manually. This file was generated by @zeit/git-hooks,
# located at ${__dirname}, for the module located at ${targetPackageDir}.
